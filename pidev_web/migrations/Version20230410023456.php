 ...
 */
final class Version20230410023456 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answers CHANGE user_id user_id INT DEFAULT NULL, CHANGE message message VARCHAR(1500) NOT NULL, CHANGE vote_nb vote_nb INT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE questions CHANGE subject_id subject_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE title title VARCHAR(1500) NOT NULL, CHANGE description description VARCHAR(15000) NOT NULL, CHANGE created_at created_at DATETIME NOT NULL');
        ...
        $this->addSql('ALTER TABLE sessions ADD max_places INT NOT NULL, CHANGE id_course id_course INT DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL, CHANGE places places INT NOT NULL, CHANGE meet_link meet_link VARCHAR(500) NOT NULL, CHANGE image_link image_link VARCHAR(500) NOT NULL');
        ...
        $this->addSql('ALTER TABLE users ADD id_user INT NOT NULL, CHANGE bio bio VARCHAR(500) NOT NULL, CHANGE avatar_path avatar_path VARCHAR(300) NOT NULL, CHANGE score score INT NOT NULL, CHANGE type type VARCHAR(50) NOT NULL, CHANGE warnings warnings INT NOT NULL');
        $this->addSql('ALTER TABLE users ADD CONSTRAINT FK_1483A5E96B3CA4B FOREIGN KEY (id_user) REFERENCES test_results (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_1483A5E96B3CA4B ON users (id_user)');
        ...
        $this->addSql('ALTER TABLE votes CHANGE id_user id_user INT DEFAULT NULL, CHANGE answer_id answer_id INT DEFAULT NULL, CHANGE vote_type vote_type INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answers CHANGE user_id user_id INT NOT NULL, CHANGE message message TEXT DEFAULT NULL, CHANGE vote_nb vote_nb INT DEFAULT 0, CHANGE created_at created_at DATETIME DEFAULT \'current_timestamp()\' NOT NULL');
        ...
        $this->addSql('ALTER TABLE sessions DROP max_places, CHANGE id_course id_course INT NOT NULL, CHANGE id_user id_user INT NOT NULL, CHANGE places places TINYINT(1) DEFAULT NULL, CHANGE meet_link meet_link VARCHAR(500) DEFAULT \'NULL\', CHANGE image_link image_link VARCHAR(500) DEFAULT \'NULL\'');
        ...
        $this->addSql('ALTER TABLE users DROP FOREIGN KEY FK_1483A5E96B3CA4B');
        $this->addSql('DROP INDEX UNIQ_1483A5E96B3CA4B ON users');
        $this->addSql('ALTER TABLE users DROP id_user, CHANGE bio bio VARCHAR(500) DEFAULT \'NULL\', CHANGE avatar_path avatar_path VARCHAR(300) DEFAULT \'NULL\', CHANGE score score INT DEFAULT 0 NOT NULL, CHANGE type type VARCHAR(50) DEFAULT \'\'\'STUDENT\'\'\' NOT NULL, CHANGE warnings warnings TINYINT(1) DEFAULT 0 NOT NULL');
        ...
        $this->addSql('ALTER TABLE votes CHANGE answer_id answer_id INT NOT NULL, CHANGE id_user id_user INT NOT NULL, CHANGE vote_type vote_type TINYINT(1) DEFAULT NULL');
