 ...
 */
final class Version20230422223250 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ADD roles JSON NOT NULL, CHANGE first_name first_name VARCHAR(255) NOT NULL, CHANGE last_name last_name VARCHAR(255) NOT NULL, CHANGE bio bio VARCHAR(255) NOT NULL, CHANGE avatar_path avatar_path VARCHAR(255) NOT NULL, CHANGE score score INT NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, CHANGE password password VARCHAR(255) NOT NULL, CHANGE type type VARCHAR(255) NOT NULL, CHANGE warnings warnings INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users DROP roles, CHANGE first_name first_name VARCHAR(100) NOT NULL, CHANGE last_name last_name VARCHAR(100) NOT NULL, CHANGE bio bio VARCHAR(500) DEFAULT \'NULL\', CHANGE avatar_path avatar_path VARCHAR(300) DEFAULT \'NULL\', CHANGE score score INT DEFAULT 0 NOT NULL, CHANGE email email VARCHAR(200) NOT NULL, CHANGE password password VARCHAR(1000) NOT NULL, CHANGE type type VARCHAR(50) DEFAULT \'\'\'STUDENT\'\'\' NOT NULL, CHANGE warnings warnings TINYINT(1) DEFAULT 0 NOT NULL');
