...
import config.DateTime_helpers;
import types.Getter_setter_map;
import types.Getter_setter_pair;

public class Session extends Base_entity {
  private Integer id;
  ...
  public Session() {
    Getter_setter_map map = build_getter_setter_map(
        new Getter_setter_pair("date", "get_date_sqlDate", "set_date"),
        new Getter_setter_pair("start_time", "get_start_time_sqlTime", "set_start_time"),
        new Getter_setter_pair("end_time", "get_end_time_sqlTime", "set_end_time"));
