...
public class Test_data {
    ...
    public static void clear_db() {
        ...
        List<String> tables = Arrays.asList(
                "votes", "answers", "questions", "participations", "test_results", "test_qs", "tests", "resources",
                "sessions",
    ...
    public static List<Subject> insert_subjects() {
        ...
        List<Subject.Class_esprit> classes_esprit_1 = Arrays.asList(Subject.Class_esprit.A1, Subject.Class_esprit.P2);
    ...
    public static List<Course> insert_courses(List<Subject> subjects) {
        ...
        courses_list.add(new Course("Types des variables", course_description_1, Course.Difficulty.EASY.toString()));
        courses_list.get(0).set_subject(subjects.get(0));

        courses_list.add(new Course("Structure de données", course_description_2, Course.Difficulty.EASY.toString()));
    ...
    public static List<Test_qs> insert_test_questions(List<Test> tests) {
        ...
        test_questions.add(new Test_qs(1, question_1, question_1_response, question_1_optionA, question_1_optionB,
                question_1_optionC, question_1_optionD));
        test_questions.get(0).set_test(tests.get(0));

        test_questions.add(new Test_qs(1, question_2, question_2_response, question_2_optionA, question_2_optionB,
                question_2_optionC, question_2_optionD));
        test_questions.get(1).set_test(tests.get(1));

        test_questions.add(new Test_qs(1, question_3, question_3_response, question_3_optionA, question_3_optionB,
                question_3_optionC, question_3_optionD));

        test_questions.get(2).set_test(tests.get(2));

        test_questions.add(new Test_qs(1, question_4, question_4_response, question_4_optionA, question_4_optionB,
                question_4_optionC, question_4_optionD));

        test_questions.get(3).set_test(tests.get(3));

        // ! 
        test_questions.add(new Test_qs(1, question_5, question_5_response, question_5_optionA, question_5_optionB,
                question_5_optionC, question_5_optionD));
        test_questions.get(4).set_test(tests.get(2));

        Log.file("before 7");
        test_questions.add(new Test_qs(2, question_8, question_8_response, question_8_optionA, question_8_optionB,
                question_8_optionC, question_8_optionD));
        test_questions.get(5).set_test(tests.get(2));

        Log.file("before 8");
        test_questions.add(new Test_qs(3, question_9, question_9_response, question_9_optionA, question_9_optionB,
                question_9_optionC, question_9_optionD));
        test_questions.get(6).set_test(tests.get(2));

        Log.file("before 9");
        test_questions.add(new Test_qs(4, question_10, question_10_response, question_10_optionA, question_10_optionB,
                question_10_optionC, question_10_optionD));
        test_questions.get(7).set_test(tests.get(2));

        Log.file("before 10");
        test_questions.add(new Test_qs(5, question_11, question_11_response, question_11_optionA, question_11_optionB,
                question_11_optionC, question_11_optionD));
        test_questions.get(8).set_test(tests.get(2));
        //!
        test_questions.add(new Test_qs(1, question_6, question_6_response, question_6_optionA, question_6_optionB,
                question_6_optionC, question_6_optionD));
        test_questions.get(9).set_test(tests.get(5));

        test_questions.add(new Test_qs(1, question_7, question_7_response, question_7_optionA, question_7_optionB,
    ...
    public static List<Question> insert_questions(List<User> users, List<Subject> subjects) {
        ...
        questions_list.add(new Question("Quelle est la différence entre equals() et == ?", question_description_1));
        ...
        questions_list
                .add(new Question("Quelle est la différence entre la variable locale et la variable globale en C ?",
                        question_description_3));
        questions_list.get(2).set_user(users.get(2));
        questions_list.get(2).set_subject(subjects.get(0));

        questions_list.add(new Question("Qu'est-ce que le rôle du constructeur en C++ ?", question_description_4));
